...
public class Constants {
	...
	public static final float STATUS_FAILURE = 3;
	public static final String STATUS_CATEGORY_METRIC_NAME = "category_status";
	public static final String STATUS_DATABASE_METRIC_NAME = "database_status";
